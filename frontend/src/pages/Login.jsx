  ...
  return (
    <div className="flex items-center justify-center min-h-screen p-4 bg-slate-900 text-slate-100">
      <div className="w-full max-w-md p-8 border border-white/10 shadow-2xl bg-slate-800/70 backdrop-blur-xl rounded-2xl">
        <h1 className="mb-2 text-3xl font-bold text-center text-white">Welcome Back</h1>
        <p className="mb-6 text-center text-slate-400">Login to manage your tasks and projects</p>
        ...
        <div className="mt-6 text-sm text-center text-slate-400">
          Don't have an account? <Link to="/register" className="text-blue-400 hover:text-blue-300 hover:underline">Create one now</Link>
        </div>
      </div>
    </div>
  );
